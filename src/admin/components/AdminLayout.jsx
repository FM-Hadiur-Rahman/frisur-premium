    ...
    <div className="min-h-screen bg-[#0f0b12] text-[#f8f0e3]">
      <div className="grid min-h-screen grid-cols-[260px_1fr]">
        <aside className="border-r border-[#c8ae72]/10 bg-[#120d12] px-4 py-6">
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-[#fff3d7]">
              Maison Élégance
            </h2>
            <p className="mt-2 text-sm text-[#c8ae72]">Admin Panel</p>
          </div>
          ...
          <div className="mt-10 rounded-2xl border border-[#c8ae72]/10 bg-white/5 p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-[#cbbda8]">
              Öffentliches Frontend und Admin können später mit Backend
              verbunden werden.
            </p>
          </div>
        </aside>
